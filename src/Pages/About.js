      ...
      <Box display="flex" flexDirection="row-reverse" p={1} m={1} className={classes.profile1}>
         ...
         <Box className={classes.descriptionBox}>
            ...
            <Typography className={classes.description}>
              My name is Arushi Arora. I'm currently a 3rd year CSE student 
            ...
            <Typography className={classes.description2}>
              ...
              experiences. I am passionate about machine learning, 
              artificial intelligence, cybersecurity, and sustainable engineering, although
              I am quickly discovering new interests in the area of cloud data storage as well. My main and strongest areas of
